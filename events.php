    ...
    <div class="wrapper" style="overflow:hidden;">
        ...
        <div class="form-box login">
          ...
          if(isset($_POST['submit'])){
              ...
              $result = mysqli_query($conn, "SELECT * FROM signupevent WHERE username='$username' AND password='$password' ") or die("Query Error: " . mysqli_error($conn));
            ...
            <form method="POST" action="">
                ...
                <div class="logreg-link animation">
                    <p>Don't have an account <a href="eventsignup.php" class="" style="--i:4;">Sign Up</a></p>
                </div>
            </form>
        </div>
