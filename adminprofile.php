    ...
    <div class="wrapper" style="overflow:hidden;">
        ...
        <div class="form-box login">
          ...
          if(isset($_POST['submit'])){
              ...
              $result = mysqli_query($conn, "SELECT * FROM adminlogin WHERE username='$username' AND password='$password' ") or die("Query Error: " . mysqli_error($conn));
        ...
        <div class="info-text login">
            <h2 class="animation" style="--i:0;">Welcome Admin!</h2>
            <p class="animation" style="--i:1;">Please log in using your personal information to manage your system.</p>
        </div>
        <?php }?>
    </div>
