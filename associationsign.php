    ...
    <div class="wrapper" style="overflow:hidden;">
        ...
        <div class="form-box login">
            ...
            if(isset($_POST['submit'])){
                ...
                $verify_query = mysqli_query($conn,"SELECT username FROM signupasso WHERE username='$username'");
                ...
                if(mysqli_num_rows($verify_query) !=0 ){
                    ...
                    mysqli_query($conn,"INSERT INTO signupasso(username,email,password) VALUES('$username','$email','$password')") or die("Error Occurred");
            ...
            <form method="POST"  action=""  onsubmit="return validateForm()" name="registrationasso">
                ...
                <div class="logreg-link animation">
                    <p>Already have an account <a href="association.php" class="" style="--i:4;">Log In</a></p>
                </div>
            </form>
            <?php } ?>
        </div>
