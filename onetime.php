...
<body>
   <input type="checkbox" id="menu-toggle">
                ...
                <ul>
                    ...
                    <li>
                        <a href="a.php" class="active" >
                            <span class="las la-hand-pointer" class="active"></span>
    ...
    <div class="main-content">
        ...
        <header>
            <div class="header-content">
                ...
                <div class="header-menu">
                    ...
                    <div class="user">
                        <div class="bg-img" style="background-image: url(img/1.jpeg),width:100px;" ></div>
        ...
        <main>
            ...
            <div class="page-header">
                <h1 style="color:#152d53;">Details of all associations that assigned by one time event</h1>
    ...
    $event_query = "SELECT eventt.eventname, eventt.phone  AS event_phone,eventt.eventday AS days, association.name AS association_name, association.phone AS association_phone,
        ...
        FROM assdriver
        INNER JOIN eventt ON assdriver.eid = eventt.eid 
        INNER JOIN association ON assdriver.aid = association.aid
        LEFT JOIN driver ON assdriver.eid = driver.eid
        LEFT JOIN volunteers ON driver.vid = volunteers.vid
        LEFT JOIN assistant ON assdriver.eid = assistant.eid
